...
WEB = Path(__file__).resolve().parent.parent / "raw/usr/share/casaos/www/modules/cron"
...
def main():
    ...
    used = used_keys()
    dynamic_prefixes = ("result.", "error.", "tpl.", "webhookFormat.", "schedule.")
    ...
    # every language carries; keys built at runtime (t(`result.${x}`)) are
